...
class TestISR:
    ...
    def test_isr_second_bracket(self):
        # 1000 in bracket (844.60-7168.51) of ISR_MENSUAL_2026
        # (b2b_ai/fiscal_tables.py, Anexo 8 RMF 2026):
        # (1000-844.60)*6.4% + 16.22 = 26.17
    ...
    def test_isr_high_income(self):
        ...
        # (b2b_ai/fiscal_tables.py, Anexo 8 RMF 2026):
        # (100000-96006.06)*34% + 24729.61 = 26087.55
