# -*- coding: utf-8 -*-
"""
test_demo_e2e.py — End-to-end tests for the Atiende Despachos demo module.
...
def _make_demo_app() -> FastAPI:
    ...
    app = FastAPI(title="Atiende Despachos — E2E Test")
...
class TestReportPdfE2E:
    ...
    def test_report_pdf_named_correctly(self, firm_data, tmp_path):
        ...
        pdf_path = generate_roi_report(firm_data, str(tmp_path))
        assert os.path.basename(pdf_path) == "Atiende_Despachos_Reporte_ROI_Demo.pdf"
