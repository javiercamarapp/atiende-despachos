...
Forma de uso:
    ...
    mgr = OutreachManager(db=db, tenant_id=1,
                          ...
                          sender_first_name="Ana", sender_company="Atiende Despachos")
...
SEQUENCE_SUBJECTS: Dict[int, str] = {
    1: "Atiende Despachos — automatización contable para {company}",
...
class OutreachManager:
    ...
    def __init__(self, db: Optional[Database] = None, tenant_id: Optional[int] = None,
                 ...
                 sender_company: str = "Atiende Despachos", reply_to: Optional[str] = None,
