...
|---|----------|-----------|----------|-----------|
| H-05 | Migration v15 falta en Alembic | CRÍTICO | 30min | **P0 — Fix ahora** |
| H-22 | paused_at guarda literal string | ALTO | 5min | **P0 — Fix ahora** |
| H-10 | count_audit sin tenant_id | ALTO | 5min | **P0 — Fix ahora** |
| H-08 | SELECT * masivo | CRÍTICO | 2h | **P1 — Sprint actual** |
| H-01 | Monetarios como TEXT | CRÍTICO | 4h | **P1 — Sprint actual** |
| H-09 | N+1 en _find_tenant | ALTO | 10min | **P1 — Sprint actual** |
| H-18 | Sin RLS en PostgreSQL | ALTO | 4h | **P1 — Sprint actual** |
| H-15 | Pool triplicado | ALTO | 4h | **P2 — Próximo sprint** |
| H-26 | Sin backup automatizado | ALTO | 2h | **P2 — Próximo sprint** |
| H-27 | Retención CFF Art. 30 | ALTO | 1h | **P2 — Próximo sprint** |
| H-02 | Fechas como TEXT | ALTO | 4h | **P2 — Próximo sprint** |
| H-03 | FKs faltantes | MEDIO | 2h | **P2 — Próximo sprint** |
| H-21 | commit() inconsistente | ALTO | 2h | **P2 — Próximo sprint** |
| H-11 | leads sin tenant_id | ALTO | 1h | **P3** |
| H-19 | leads sin tenant_id (schema) | MEDIO | 1h | **P3** |
| H-20 | tenant_id nullable | MEDIO | 2h | **P3** |
| H-06 | migration 2.py duplicado | MEDIO | 1min | **P3** |
| H-04 | Índices faltantes | MEDIO | 30min | **P3** |
| H-12 | SQL injection f-string | MEDIO | 5min | **P3** |
| H-13 | list_tenants sin paginación | MEDIO | 10min | **P3** |
| H-16 | Connection leak potencial | MEDIO | 10min | **P3** |
| H-17 | Enterprise pool no usado | MEDIO | 4h | **P4** |
| H-25 | enforce_retention except type | MEDIO | 5min | **P3** |
| H-30 | invoice_stats 2 queries | MEDIO | 15min | **P4** |
| H-29 | Sin EXPLAIN ANALYZE | MEDIO | 1h | **P4** |
| H-07 | COALESCE en UNIQUE INDEX | MEDIO | 30min | **P4** |
| H-31 | get_portal_session 3 queries | BAJO | 15min | **P4** |
| H-32 | migration 2.py nombre | BAJO | 1min | **P4** |
| H-33 | lastrowid extra query | BAJO | 2h | **P4** |
| H-34 | PGRecord O(n) positional | BAJO | 10min | **P4** |
| H-35 | _is_postgres duplicado | BAJO | 15min | **P4** |
