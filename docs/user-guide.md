# User Guide — Atiende Despachos

Guía práctica para contadores, auxiliares y usuarios del sistema Atiende Despachos: cómo
procesar CFDI, usar el dashboard, configurar integraciones y resolver problemas
comunes.

> **Importante**: Atiende Despachos **prepara y valida**; el profesional **determina y
...
sistema / equipo de soporte Atiende Despachos (`ventas@b2b-ai.local`).
