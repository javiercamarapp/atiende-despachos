# AUDITORÍA EXHAUSTIVA — Atiende Despachos
...
|---|---|---|
| `classifications` | Sí | No |
| `notifications` | Sí | No |
| `portal_sessions` | Sí | No |
...
|---|---|---|
| `B2B_API_KEY` | Sí | Solo en docstring |
| `B2B_JWT_SECRET` | Sí | Solo en config.py |
| `B2B_ENCRYPTION_KEY` | Sí | Solo en config.py |
| `B2B_DATABASE_URL` | Sí | Solo en config.py |
| `B2B_REDIS_URL` | Advertencia | Solo en config.py |
| `B2B_LLM_API_KEY` | Advertencia | Solo en config.py |
| `B2B_ENV` | Sí | Solo en config.py |
